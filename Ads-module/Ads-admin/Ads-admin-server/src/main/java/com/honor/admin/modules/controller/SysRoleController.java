...
import com.honor.admin.modules.entity.SysRoleEntity;
import com.honor.admin.modules.service.SysRoleMenuService;
import com.honor.admin.modules.service.SysRoleService;
...
public class SysRoleController{
	...
	public R select(UserDto userDto){
		Map<String, Object> map = new HashMap<>();
		
		//如果不是超级管理员，则只查询自己所拥有的角色列表
		if(userDto.getUserId() != Constant.SUPER_ADMIN){
			map.put("create_user_id", userDto.getUserId());
		}
	...
	public R save(@RequestBody SysRoleEntity role,UserDto userDto){
		ValidatorUtils.validateEntity(role);
		
		role.setCreateUserId(userDto.getUserId());
	...
	public R update(@RequestBody SysRoleEntity role,UserDto userDto){
		ValidatorUtils.validateEntity(role);
